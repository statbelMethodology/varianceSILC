...
Tous nos utilisateurs ayant accès aux micro-données pourront à présent
obtenir le fichier des poids répliqués. Celui-ci sera sous le même
...
la strate et le facteur de correction.
...
assez faibles pour des grands échantillons, et c'est pour des
sous-populations très petites (donc déjà des estimateurs de variance peu
fiables) que les écarts entre les deux méthodes est forte. Je ne vois
